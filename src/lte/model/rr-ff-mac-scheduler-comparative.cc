...
#include <ns3/rr-ff-mac-scheduler-comparative.h>
...
NS_LOG_COMPONENT_DEFINE ("RrFfMacSchedulerComparative");
...
NS_OBJECT_ENSURE_REGISTERED (RrFfMacSchedulerComparative);


class RrSchedulerCompMemberCschedSapProvider : public FfMacCschedSapProvider
{
public:
  RrSchedulerCompMemberCschedSapProvider (RrFfMacSchedulerComparative* scheduler);
...
private:
  RrSchedulerCompMemberCschedSapProvider ();
  RrFfMacSchedulerComparative* m_scheduler;
};

RrSchedulerCompMemberCschedSapProvider::RrSchedulerCompMemberCschedSapProvider ()
{
}

RrSchedulerCompMemberCschedSapProvider::RrSchedulerCompMemberCschedSapProvider (RrFfMacSchedulerComparative* scheduler) : m_scheduler (scheduler)
{
}


void
RrSchedulerCompMemberCschedSapProvider::CschedCellConfigReq (const struct CschedCellConfigReqParameters& params)
{
  m_scheduler->DoCschedCellConfigReq (params);
}

void
RrSchedulerCompMemberCschedSapProvider::CschedUeConfigReq (const struct CschedUeConfigReqParameters& params)
{
...
void
RrSchedulerCompMemberCschedSapProvider::CschedLcConfigReq (const struct CschedLcConfigReqParameters& params)
{
  m_scheduler->DoCschedLcConfigReq (params);
}

void
RrSchedulerCompMemberCschedSapProvider::CschedLcReleaseReq (const struct CschedLcReleaseReqParameters& params)
{
  m_scheduler->DoCschedLcReleaseReq (params);
}

void
RrSchedulerCompMemberCschedSapProvider::CschedUeReleaseReq (const struct CschedUeReleaseReqParameters& params)
{
...
class RrSchedulerCompMemberSchedSapProvider : public FfMacSchedSapProvider
{
public:
  RrSchedulerCompMemberSchedSapProvider (RrFfMacSchedulerComparative* scheduler);
...
private:
  RrSchedulerCompMemberSchedSapProvider ();
  RrFfMacSchedulerComparative* m_scheduler;
};



RrSchedulerCompMemberSchedSapProvider::RrSchedulerCompMemberSchedSapProvider ()
{
}


RrSchedulerCompMemberSchedSapProvider::RrSchedulerCompMemberSchedSapProvider (RrFfMacSchedulerComparative* scheduler)
  : m_scheduler (scheduler)
{
}

void
RrSchedulerCompMemberSchedSapProvider::SchedDlRlcBufferReq (const struct SchedDlRlcBufferReqParameters& params)
{
  m_scheduler->DoSchedDlRlcBufferReq (params);
}

void
RrSchedulerCompMemberSchedSapProvider::SchedDlPagingBufferReq (const struct SchedDlPagingBufferReqParameters& params)
{
  m_scheduler->DoSchedDlPagingBufferReq (params);
}

void
RrSchedulerCompMemberSchedSapProvider::SchedDlMacBufferReq (const struct SchedDlMacBufferReqParameters& params)
{
  m_scheduler->DoSchedDlMacBufferReq (params);
}

void
RrSchedulerCompMemberSchedSapProvider::SchedDlTriggerReq (const struct SchedDlTriggerReqParameters& params)
{
  m_scheduler->DoSchedDlTriggerReq (params);
}

void
RrSchedulerCompMemberSchedSapProvider::SchedDlRachInfoReq (const struct SchedDlRachInfoReqParameters& params)
{
  m_scheduler->DoSchedDlRachInfoReq (params);
}

void
RrSchedulerCompMemberSchedSapProvider::SchedDlCqiInfoReq (const struct SchedDlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedDlCqiInfoReq (params);
}

void
RrSchedulerCompMemberSchedSapProvider::SchedUlTriggerReq (const struct SchedUlTriggerReqParameters& params)
{
  m_scheduler->DoSchedUlTriggerReq (params);
}

void
RrSchedulerCompMemberSchedSapProvider::SchedUlNoiseInterferenceReq (const struct SchedUlNoiseInterferenceReqParameters& params)
{
  m_scheduler->DoSchedUlNoiseInterferenceReq (params);
}

void
RrSchedulerCompMemberSchedSapProvider::SchedUlSrInfoReq (const struct SchedUlSrInfoReqParameters& params)
{
  m_scheduler->DoSchedUlSrInfoReq (params);
}

void
RrSchedulerCompMemberSchedSapProvider::SchedUlMacCtrlInfoReq (const struct SchedUlMacCtrlInfoReqParameters& params)
{
  m_scheduler->DoSchedUlMacCtrlInfoReq (params);
}

void
RrSchedulerCompMemberSchedSapProvider::SchedUlCqiInfoReq (const struct SchedUlCqiInfoReqParameters& params)
{
...
RrFfMacSchedulerComparative::RrFfMacSchedulerComparative ()
  :   m_cschedSapUser (0),
    m_schedSapUser (0),
    m_nextRntiDl (0),
    m_nextRntiUl (0)
{
  ...
  m_cschedSapProvider = new RrSchedulerCompMemberCschedSapProvider (this);
  m_schedSapProvider = new RrSchedulerCompMemberSchedSapProvider (this);
}
...
void
RrFfMacSchedulerComparative::DoDispose ()
{
  NS_LOG_FUNCTION (this);
...
TypeId
RrFfMacSchedulerComparative::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::RrFfMacSchedulerComparative")
    .SetParent<FfMacScheduler> ()
    .SetGroupName("Lte")
    .AddConstructor<RrFfMacSchedulerComparative> ()
    .AddAttribute ("CqiTimerThreshold",
                   "The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
                   UintegerValue (1000),
                   MakeUintegerAccessor (&RrFfMacSchedulerComparative::m_cqiTimersThreshold),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("HarqEnabled",
                   "Activate/Deactivate the HARQ [by default is active].",
                   BooleanValue (false), // Ponemos las retransmisiones en desactivadas por defecto
                   MakeBooleanAccessor (&RrFfMacSchedulerComparative::m_harqOn),
                   MakeBooleanChecker ())
    .AddAttribute ("UlGrantMcs",
                   "The MCS of the UL grant, must be [0..15] (default 0)",
                   UintegerValue (0),
                   MakeUintegerAccessor (&RrFfMacSchedulerComparative::m_ulGrantMcs),
                   MakeUintegerChecker<uint8_t> ())
	.AddAttribute ("FilesEnabled",
				   "Indicate if files have to be created",
				   BooleanValue (false), // a false para desactivarlo
				   MakeBooleanAccessor (&RrFfMacSchedulerComparative::m_generateFiles),
				   MakeBooleanChecker ())
...
void
RrFfMacSchedulerComparative::SetFfMacCschedSapUser (FfMacCschedSapUser* s)
{
  m_cschedSapUser = s;
}

void
RrFfMacSchedulerComparative::SetFfMacSchedSapUser (FfMacSchedSapUser* s)
{
  m_schedSapUser = s;
}

FfMacCschedSapProvider*
RrFfMacSchedulerComparative::GetFfMacCschedSapProvider ()
{
  return m_cschedSapProvider;
}

FfMacSchedSapProvider*
RrFfMacSchedulerComparative::GetFfMacSchedSapProvider ()
{
  return m_schedSapProvider;
}

void
RrFfMacSchedulerComparative::SetLteFfrSapProvider (LteFfrSapProvider* s)
{
  m_ffrSapProvider = s;
}

LteFfrSapUser*
RrFfMacSchedulerComparative::GetLteFfrSapUser ()
{
  return m_ffrSapUser;
}

void
RrFfMacSchedulerComparative::DoCschedCellConfigReq (const struct FfMacCschedSapProvider::CschedCellConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
RrFfMacSchedulerComparative::DoCschedUeConfigReq (const struct FfMacCschedSapProvider::CschedUeConfigReqParameters& params)
{
...
void
RrFfMacSchedulerComparative::DoCschedLcConfigReq (const struct FfMacCschedSapProvider::CschedLcConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
RrFfMacSchedulerComparative::DoCschedLcReleaseReq (const struct FfMacCschedSapProvider::CschedLcReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
RrFfMacSchedulerComparative::DoCschedUeReleaseReq (const struct FfMacCschedSapProvider::CschedUeReleaseReqParameters& params)
{
...
void
RrFfMacSchedulerComparative::DoSchedDlRlcBufferReq (const struct FfMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
{
...
void
RrFfMacSchedulerComparative::DoSchedDlPagingBufferReq (const struct FfMacSchedSapProvider::SchedDlPagingBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
RrFfMacSchedulerComparative::DoSchedDlMacBufferReq (const struct FfMacSchedSapProvider::SchedDlMacBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  NS_FATAL_ERROR ("method not implemented");
  return;
...
int
RrFfMacSchedulerComparative::GetRbgSize (int dlbandwidth)
{
  for (int i = 0; i < 4; i++)
    {
...
bool
RrFfMacSchedulerComparative::SortRlcBufferReq (FfMacSchedSapProvider::SchedDlRlcBufferReqParameters i,FfMacSchedSapProvider::SchedDlRlcBufferReqParameters j)
{
...
uint8_t
RrFfMacSchedulerComparative::HarqProcessAvailability (uint16_t rnti)
{
...
uint8_t
RrFfMacSchedulerComparative::UpdateHarqProcessId (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
void
RrFfMacSchedulerComparative::RefreshHarqProcesses ()
{
  NS_LOG_FUNCTION (this);
...
void
RrFfMacSchedulerComparative::DoSchedDlTriggerReq (const struct FfMacSchedSapProvider::SchedDlTriggerReqParameters& params)
{
	  std::cout << "------> LANZAMOS SCHEDULER DL" << std::endl;
  NS_LOG_FUNCTION (this << " DL Frame no. " << (params.m_sfnSf >> 4) << " subframe no. " << (0xF & params.m_sfnSf));
  std::cout << " DL Frame no. " << (params.m_sfnSf >> 4) << " subframe no. " << (0xF & params.m_sfnSf) << " Celda " << params.m_cellId << std::endl;
  ...
  // COMIENZA LA ASIGNACION DE RECURSOS

  // Abrimos fichero para escribir resultados de scheduler
  if (m_generateFiles)
  {
	  m_pSchedFile = fopen ("RR_Scheduler_Results_DL.txt","a");
	  fprintf(m_pSchedFile,"--------- Trama %d Subtrama %d , Celda % d ", params.m_sfnSf >> 4, 0xF & params.m_sfnSf, params.m_cellId);
  }

  // Get the actual active flows (queue!=0) -> Obtenemos el flujo de datos activos, es decir, aquellos canales logicos que no tienen la cola RLC vacia
  // Para cada RNTI vamos a obtener el numero de canales logicos activos
  std::list<FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it;
  std::map <uint16_t, std::vector <uint16_t> > allocationMap; // Mapa con las asignaciones RNTI-subbandas
  m_rlcBufferReq.sort (SortRlcBufferReq); // Ordenamos el buffer m_rlcBufferReq en orden creciente de RNTI
  int nflows = 0;
  int nTbs = 0;
  ...
  bool timeFile = true; // Variable para escribir el instante de tiempo en el fichero solo una vez
  for (it = m_rlcBufferReq.begin (); it != m_rlcBufferReq.end (); it++)
    {
      ...
      if ( (((*it).m_rlcTransmissionQueueSize > 0)
...

        {
          ...
          std::cout << " User " << (*it).m_rnti << " LC " << (uint16_t)(*it).m_logicalChannelIdentity << " is active, status  " << (*it).m_rlcStatusPduSize << " retx " << (*it).m_rlcRetransmissionQueueSize << " tx " << (*it).m_rlcTransmissionQueueSize << std::endl;
          std::map <uint16_t,uint8_t>::iterator itCqi = m_p10CqiRxed.find ((*it).m_rnti); // CQI wideband
          uint8_t cqi = 0;
          if (itCqi != m_p10CqiRxed.end ())
            {
              cqi = (*itCqi).second; // CQI wideband
              // Obtenemos instante de tiempo
              if (timeFile)
              {
				  int now = Simulator::Now().GetMilliSeconds();
				  if (m_generateFiles)
				     fprintf(m_pSchedFile,", Instante de tiempo: %d---------\n",now);
				  timeFile=false;
              }
            }
          else
          ...
          if (cqi != 0) // Evaluamos que ademas de tener datos a tx dichos UEs tengan informacion de CQI para considerarlos como flujos activos
            {
              ...
              if (itLcRnti != lcActivesPerRnti.end ())
              ...
              else
                {
                  ...
                  nTbs++; // Cada vez que insertamos un RNTI en el mapa, incrementamos esta variable, nTbs esun contador de RNTIs con flujos activos
                }
  ...
  if (nflows == 0) // Si no hay flujos activos pasamos la decision al scheduler y acabamos
    {
      if ((ret.m_buildDataList.size () > 0) || (ret.m_buildRarList.size () > 0))
        {
          m_schedSapUser->SchedDlConfigInd (ret);
  ...
  // En caso contrario, nflows >0 dividimos los recursos entre los usuarios por igual
  // Divide the resource equally among the active users according to
  // Resource allocation type 0 (see sec 7.1.6.1 of 36.213)

  int rbgPerTb = (nTbs > 0) ? ((rbgNum - rbgAllocatedNum) / nTbs) : INT_MAX; // Obtenemos las subbandas por UE de entre las subbandas disponibles
  ...
  do
    {
          ...
          while (it != m_rlcBufferReq.end ())
            {
              ...
              it++; // Obtenemos otro RNTI que tenga active queue o no haya sido asignado por HARQ
            }
          if (it == m_rlcBufferReq.end ())
            {
      ...
      int lcNum = (*itLcRnti).second; // Numero de canales logicos que tiene ese usuario
      ...
      while ((*it).m_rnti == newEl.m_rnti)
        {
          if ( ((*it).m_rlcTransmissionQueueSize > 0)
               ...
               || ((*it).m_rlcStatusPduSize > 0) )
            {
              ...
              lcNum--; // Una vez introducidos los datos de este canal logico a la lista de pdus RLC, decrementamos el numero de canales logicos pendientes
            }
          it++;
          if (it == m_rlcBufferReq.end ())
            {
      ...
      std::cout << " DL - Allocate user " << newEl.m_rnti << " LCs " << (uint16_t)(*itLcRnti).second << " bytes " << tbSize << " mcs " << (uint16_t) newDci.m_mcs.at (0) << std::endl;
      NS_LOG_INFO ("RBG:");
          ...
          if (rbgMap.at (rbgAllocated) == false)
            {
              ...
              i++; // Contador de subbandas asignadas al UE
              rbgMap.at (rbgAllocated) = true;
              rbgAllocatedNum++;
            }

//          (*itAlloc).second.push_back(rbgAllocated);
          temp.push_back(rbgAllocated);
          rbgAllocated++;
        }

      std::map <uint16_t, std::vector <uint16_t> >::iterator itAlloc;
      itAlloc = allocationMap.find(newEl.m_rnti);
      if (itAlloc == allocationMap.end())
      {
          allocationMap.insert (std::pair <uint16_t, std::vector <uint16_t> > (newEl.m_rnti, temp));
      }
      else
      {
//    	  for (int i=0; (uint16_t)i < temp.size(); i++)
//    	  {
//        	  (*itAlloc).second.push_back(temp.at(i));
//    	  }
    	  (*itAlloc).second=temp;
      }

	  std::cout << "Usuario: " << newEl.m_rnti << " Subbandas asignadas: " << temp.front() << " a " << temp.back() << std::endl;

      if (m_generateFiles)
      {
    	  fprintf(m_pSchedFile, "Usuario: %d -> Subbandas asignadas: ", newEl.m_rnti);
    	  for (int i=0; (uint16_t)i<temp.size(); i++)
    	  {
    		  fprintf(m_pSchedFile, "%d, ", temp.at(i));
    		  std::cout << " " << temp.at(i) ;
    	  }
    	  fprintf(m_pSchedFile, "\n");
      }
...
void
RrFfMacSchedulerComparative::DoSchedDlRachInfoReq (const struct FfMacSchedSapProvider::SchedDlRachInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
RrFfMacSchedulerComparative::DoSchedDlCqiInfoReq (const struct FfMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
RrFfMacSchedulerComparative::DoSchedUlTriggerReq (const struct FfMacSchedSapProvider::SchedUlTriggerReqParameters& params)
{
...
void
RrFfMacSchedulerComparative::DoSchedUlNoiseInterferenceReq (const struct FfMacSchedSapProvider::SchedUlNoiseInterferenceReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
RrFfMacSchedulerComparative::DoSchedUlSrInfoReq (const struct FfMacSchedSapProvider::SchedUlSrInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
RrFfMacSchedulerComparative::DoSchedUlMacCtrlInfoReq (const struct FfMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
RrFfMacSchedulerComparative::DoSchedUlCqiInfoReq (const struct FfMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
RrFfMacSchedulerComparative::RefreshDlCqiMaps (void)
{
...
void
RrFfMacSchedulerComparative::RefreshUlCqiMaps (void)
{
  // refresh UL CQI  Map
...
void
RrFfMacSchedulerComparative::UpdateDlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
  NS_LOG_FUNCTION (this);
  std::list<FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it;
  for (it = m_rlcBufferReq.begin (); it != m_rlcBufferReq.end (); it++)
...
void
RrFfMacSchedulerComparative::UpdateUlRlcBufferInfo (uint16_t rnti, uint16_t size)
{
...
void
RrFfMacSchedulerComparative::TransmissionModeConfigurationUpdate (uint16_t rnti, uint8_t txMode)
{
