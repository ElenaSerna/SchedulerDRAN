...
#ifndef PF_FF_MAC_SCHEDULER_COMPARATIVE_H
#define PF_FF_MAC_SCHEDULER_COMPARATIVE_H
...
class PfFfMacSchedulerComparative : public FfMacScheduler
{
public:
  /**
   * \brief Constructor
   ...
   */
  PfFfMacSchedulerComparative ();

  /**
   * Destructor
   */
  virtual ~PfFfMacSchedulerComparative ();
  ...
  friend class PfSchedulerCompMemberCschedSapProvider;
  friend class PfSchedulerCompMemberSchedSapProvider;
