...
#include <ns3/pf-ff-mac-scheduler-comparative.h>
...
NS_LOG_COMPONENT_DEFINE ("PfFfMacSchedulerComparative");
...
NS_OBJECT_ENSURE_REGISTERED (PfFfMacSchedulerComparative);



class PfSchedulerCompMemberCschedSapProvider : public FfMacCschedSapProvider
{
public:
  PfSchedulerCompMemberCschedSapProvider (PfFfMacSchedulerComparative* scheduler);
...
private:
  PfSchedulerCompMemberCschedSapProvider ();
  PfFfMacSchedulerComparative* m_scheduler;
};

PfSchedulerCompMemberCschedSapProvider::PfSchedulerCompMemberCschedSapProvider ()
{
}

PfSchedulerCompMemberCschedSapProvider::PfSchedulerCompMemberCschedSapProvider (PfFfMacSchedulerComparative* scheduler) : m_scheduler (scheduler)
{
}


void
PfSchedulerCompMemberCschedSapProvider::CschedCellConfigReq (const struct CschedCellConfigReqParameters& params)
{
  m_scheduler->DoCschedCellConfigReq (params);
}

void
PfSchedulerCompMemberCschedSapProvider::CschedUeConfigReq (const struct CschedUeConfigReqParameters& params)
{
...
void
PfSchedulerCompMemberCschedSapProvider::CschedLcConfigReq (const struct CschedLcConfigReqParameters& params)
{
  m_scheduler->DoCschedLcConfigReq (params);
}

void
PfSchedulerCompMemberCschedSapProvider::CschedLcReleaseReq (const struct CschedLcReleaseReqParameters& params)
{
  m_scheduler->DoCschedLcReleaseReq (params);
}

void
PfSchedulerCompMemberCschedSapProvider::CschedUeReleaseReq (const struct CschedUeReleaseReqParameters& params)
{
...
class PfSchedulerCompMemberSchedSapProvider : public FfMacSchedSapProvider
{
public:
  PfSchedulerCompMemberSchedSapProvider (PfFfMacSchedulerComparative* scheduler);
...
private:
  PfSchedulerCompMemberSchedSapProvider ();
  PfFfMacSchedulerComparative* m_scheduler;
};



PfSchedulerCompMemberSchedSapProvider::PfSchedulerCompMemberSchedSapProvider ()
{
}


PfSchedulerCompMemberSchedSapProvider::PfSchedulerCompMemberSchedSapProvider (PfFfMacSchedulerComparative* scheduler)
  : m_scheduler (scheduler)
{
}

void
PfSchedulerCompMemberSchedSapProvider::SchedDlRlcBufferReq (const struct SchedDlRlcBufferReqParameters& params)
{
  m_scheduler->DoSchedDlRlcBufferReq (params);
}

void
PfSchedulerCompMemberSchedSapProvider::SchedDlPagingBufferReq (const struct SchedDlPagingBufferReqParameters& params)
{
  m_scheduler->DoSchedDlPagingBufferReq (params);
}

void
PfSchedulerCompMemberSchedSapProvider::SchedDlMacBufferReq (const struct SchedDlMacBufferReqParameters& params)
{
  m_scheduler->DoSchedDlMacBufferReq (params);
}

void
PfSchedulerCompMemberSchedSapProvider::SchedDlTriggerReq (const struct SchedDlTriggerReqParameters& params)
{
  m_scheduler->DoSchedDlTriggerReq (params);
}

void
PfSchedulerCompMemberSchedSapProvider::SchedDlRachInfoReq (const struct SchedDlRachInfoReqParameters& params)
{
  m_scheduler->DoSchedDlRachInfoReq (params);
}

void
PfSchedulerCompMemberSchedSapProvider::SchedDlCqiInfoReq (const struct SchedDlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedDlCqiInfoReq (params);
}

void
PfSchedulerCompMemberSchedSapProvider::SchedUlTriggerReq (const struct SchedUlTriggerReqParameters& params)
{
  m_scheduler->DoSchedUlTriggerReq (params);
}

void
PfSchedulerCompMemberSchedSapProvider::SchedUlNoiseInterferenceReq (const struct SchedUlNoiseInterferenceReqParameters& params)
{
  m_scheduler->DoSchedUlNoiseInterferenceReq (params);
}

void
PfSchedulerCompMemberSchedSapProvider::SchedUlSrInfoReq (const struct SchedUlSrInfoReqParameters& params)
{
  m_scheduler->DoSchedUlSrInfoReq (params);
}

void
PfSchedulerCompMemberSchedSapProvider::SchedUlMacCtrlInfoReq (const struct SchedUlMacCtrlInfoReqParameters& params)
{
  m_scheduler->DoSchedUlMacCtrlInfoReq (params);
}

void
PfSchedulerCompMemberSchedSapProvider::SchedUlCqiInfoReq (const struct SchedUlCqiInfoReqParameters& params)
{
...
PfFfMacSchedulerComparative::PfFfMacSchedulerComparative ()
  :   m_cschedSapUser (0),
    m_schedSapUser (0),
    m_timeWindow (99.0),
    m_nextRntiUl (0)
{
  ...
  m_cschedSapProvider = new PfSchedulerCompMemberCschedSapProvider (this);
  m_schedSapProvider = new PfSchedulerCompMemberSchedSapProvider (this);
  m_ffrSapProvider = 0;
  m_ffrSapUser = new MemberLteFfrSapUser<PfFfMacSchedulerComparative> (this);
}
...
void
PfFfMacSchedulerComparative::DoDispose ()
{
  NS_LOG_FUNCTION (this);
...
TypeId
PfFfMacSchedulerComparative::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::PfFfMacSchedulerComparative")
    .SetParent<FfMacScheduler> ()
    .SetGroupName("Lte")
    .AddConstructor<PfFfMacSchedulerComparative> ()
    .AddAttribute ("CqiTimerThreshold",
                   "The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
                   UintegerValue (1000),
                   MakeUintegerAccessor (&PfFfMacSchedulerComparative::m_cqiTimersThreshold),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("HarqEnabled",
                   "Activate/Deactivate the HARQ [by default is active].",
                   BooleanValue (true),
                   MakeBooleanAccessor (&PfFfMacSchedulerComparative::m_harqOn),
                   MakeBooleanChecker ())
    .AddAttribute ("UlGrantMcs",
                   "The MCS of the UL grant, must be [0..15] (default 0)",
                   UintegerValue (0),
                   MakeUintegerAccessor (&PfFfMacSchedulerComparative::m_ulGrantMcs),
                   MakeUintegerChecker<uint8_t> ())
	.AddAttribute ("FilesEnabled",
				   "Indicate if files have to be created",
				   BooleanValue (false), // a false para desactivarlo
				   MakeBooleanAccessor (&PfFfMacSchedulerComparative::m_generateFiles),
				   MakeBooleanChecker ())
	.AddAttribute ("MaxSubbandsUE",
				   "Maximum number of subbands available per UE",
				   UintegerValue (25),
				   MakeUintegerAccessor (&PfFfMacSchedulerComparative::m_Nsubbands_user),
				   MakeUintegerChecker<uint8_t> ())
  ;
  return tid;
}
...
void
PfFfMacSchedulerComparative::SetFfMacCschedSapUser (FfMacCschedSapUser* s)
{
  m_cschedSapUser = s;
}

void
PfFfMacSchedulerComparative::SetFfMacSchedSapUser (FfMacSchedSapUser* s)
{
  m_schedSapUser = s;
}

FfMacCschedSapProvider*
PfFfMacSchedulerComparative::GetFfMacCschedSapProvider ()
{
  return m_cschedSapProvider;
}

FfMacSchedSapProvider*
PfFfMacSchedulerComparative::GetFfMacSchedSapProvider ()
{
  return m_schedSapProvider;
}

void
PfFfMacSchedulerComparative::SetLteFfrSapProvider (LteFfrSapProvider* s)
{
  m_ffrSapProvider = s;
}

LteFfrSapUser*
PfFfMacSchedulerComparative::GetLteFfrSapUser ()
{
  return m_ffrSapUser;
}

void
PfFfMacSchedulerComparative::DoCschedCellConfigReq (const struct FfMacCschedSapProvider::CschedCellConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PfFfMacSchedulerComparative::DoCschedUeConfigReq (const struct FfMacCschedSapProvider::CschedUeConfigReqParameters& params)
{
...
void
PfFfMacSchedulerComparative::DoCschedLcConfigReq (const struct FfMacCschedSapProvider::CschedLcConfigReqParameters& params)
{
...
void
PfFfMacSchedulerComparative::DoCschedLcReleaseReq (const struct FfMacCschedSapProvider::CschedLcReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PfFfMacSchedulerComparative::DoCschedUeReleaseReq (const struct FfMacCschedSapProvider::CschedUeReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PfFfMacSchedulerComparative::DoSchedDlRlcBufferReq (const struct FfMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
{
...
void
PfFfMacSchedulerComparative::DoSchedDlPagingBufferReq (const struct FfMacSchedSapProvider::SchedDlPagingBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PfFfMacSchedulerComparative::DoSchedDlMacBufferReq (const struct FfMacSchedSapProvider::SchedDlMacBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  NS_FATAL_ERROR ("method not implemented");
  return;
...
int
PfFfMacSchedulerComparative::GetRbgSize (int dlbandwidth)
{
  for (int i = 0; i < 4; i++)
    {
...
int
PfFfMacSchedulerComparative::LcActivePerFlow (uint16_t rnti)
{
  std::map <LteFlowId_t, FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it;
  int lcActive = 0;
...
uint8_t
PfFfMacSchedulerComparative::HarqProcessAvailability (uint16_t rnti)
{
...
uint8_t
PfFfMacSchedulerComparative::UpdateHarqProcessId (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
void
PfFfMacSchedulerComparative::RefreshHarqProcesses ()
{
  NS_LOG_FUNCTION (this);
...
void
PfFfMacSchedulerComparative::DoSchedDlTriggerReq (const struct FfMacSchedSapProvider::SchedDlTriggerReqParameters& params)
{
  ...
  if (m_generateFiles)
  {
	  m_pSchedFile = fopen ("PF_Scheduler_Results_DL.txt","a");
	  m_pSchedFileDet = fopen ("PF_Info_Results_DL.txt","a");
...
// int Nsubbands_user=25; // Limite de subb max disponibles para UE
                  ...
                  if (LcActivePerFlow ((*it).first) > 0)
                    {
                      ...
                      std::cout << " RNTI " << (*it).first << " MCS " << (uint32_t)mcs << " achievableRate " << achievableRate << " avgThr " << (*it).second.lastAveragedThroughput << " RCQI " << rcqi << std::endl;
					  if (m_generateFiles)
					      fprintf(m_pSchedFileDet, "RNTI %d\t MCS %d\t Achievable Rate %f\t Avg Throughput %f\t Metrica Rij %f\n", (*it).first, mcs,  achievableRate, (*it).second.lastAveragedThroughput, rcqi);
          ...
          if (itMax == m_flowStatsDl.end ())
            {
			  ...
			  if (m_generateFiles)
			  {
				  fprintf(m_pSchedFile, "\n Subband %d -> No UE disponibles para esta subbanda ", i);
				  fprintf(m_pSchedFileDet, "Subband %d -> No UE disponibles para esta subbanda\n", i);
			  }
            }
          else
            {
			  ...
			  itMapContSubbands = subbandsAsigUEs.find((*itMax).first); // Buscamos UE
        	  ...
        	  std::cout << " UE assigned: " << (*itMax).first << std::endl;
			  if (m_generateFiles)
			     fprintf(m_pSchedFile,"\n Subbanda %d -> Usuario asignado: %d; Metrica: %f", i, (*itMax).first, rcqiMax);
            }
        } // end for RBG free
    } // end for RBGs
...
void
PfFfMacSchedulerComparative::DoSchedDlRachInfoReq (const struct FfMacSchedSapProvider::SchedDlRachInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PfFfMacSchedulerComparative::DoSchedDlCqiInfoReq (const struct FfMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
double
PfFfMacSchedulerComparative::EstimateUlSinr (uint16_t rnti, uint16_t rb)
{
...
void
PfFfMacSchedulerComparative::DoSchedUlTriggerReq (const struct FfMacSchedSapProvider::SchedUlTriggerReqParameters& params)
{
...
void
PfFfMacSchedulerComparative::DoSchedUlNoiseInterferenceReq (const struct FfMacSchedSapProvider::SchedUlNoiseInterferenceReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
PfFfMacSchedulerComparative::DoSchedUlSrInfoReq (const struct FfMacSchedSapProvider::SchedUlSrInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
PfFfMacSchedulerComparative::DoSchedUlMacCtrlInfoReq (const struct FfMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
PfFfMacSchedulerComparative::DoSchedUlCqiInfoReq (const struct FfMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
// retrieve the allocation for this subframe
  ...
  switch (params.m_ulCqi.m_type)
    ...
    case UlCqi_s::PRACH:
      {
        NS_FATAL_ERROR ("PfFfMacSchedulerComparative supports only PUSCH and SRS UL-CQIs");
      }
      break;
    default:
...
void
PfFfMacSchedulerComparative::RefreshDlCqiMaps (void)
{
...
void
PfFfMacSchedulerComparative::RefreshUlCqiMaps (void)
{
  // refresh UL CQI  Map
...
void
PfFfMacSchedulerComparative::UpdateDlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
  std::map<LteFlowId_t, FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it;
...
void
PfFfMacSchedulerComparative::UpdateUlRlcBufferInfo (uint16_t rnti, uint16_t size)
{
...
void
PfFfMacSchedulerComparative::TransmissionModeConfigurationUpdate (uint16_t rnti, uint8_t txMode)
{
