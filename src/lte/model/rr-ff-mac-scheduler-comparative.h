...
#ifndef RR_FF_MAC_SCHEDULER_COMPARATIVE_H
#define RR_FF_MAC_SCHEDULER_COMPARATIVE_H
...
class RrFfMacSchedulerComparative : public FfMacScheduler
{
public:
  /**
   * \brief Constructor
   ...
   */
  RrFfMacSchedulerComparative ();

  /**
   * Destructor
   */
  virtual ~RrFfMacSchedulerComparative ();
  ...
  friend class RrSchedulerCompMemberCschedSapProvider;
  friend class RrSchedulerCompMemberSchedSapProvider;
...
#endif /* RR_FF_MAC_SCHEDULER_COMPARATIVE_H */
